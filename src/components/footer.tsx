        ...
        <div className="flex flex-col lg:flex-row lg:relative items-center">
          ...
          <div className="order-1 lg:absolute lg:left-0">
            <div className="flex flex-row space-x-5 items-center">
                <Link
                    href={"https://github.com/apavazza/lisp-interpreter/blob/master/LICENSE"}
                    target="_blank"
                    rel="noreferrer"
                ...
                <Link
                    href={"https://github.com/apavazza/lisp-interpreter"}
                    target="_blank"
                    rel="noreferrer"
                    className="text-sm text-gray-800 hover:text-gray-500 whitespace-nowrap"
                >
          ...
          <div className="order-3 lg:absolute lg:right-0">
            <p className="text-sm text-gray-800">
              Version: {process.env.NEXT_PUBLIC_GIT_HASH ? (
                <Link
                  href={`https://github.com/apavazza/lisp-interpreter/commits/${process.env.NEXT_PUBLIC_GIT_HASH}`}
                  target="_blank"
                  rel="noreferrer"
